        ...
        <div className={styles.loginFormBox}>
          <div className={styles.trustBadge}>
            <div className={styles.tinyAvatars}>
              <img src="https://i.pravatar.cc/150?u=1" className={styles.tinyAvatar} alt="user" />
              <img src="https://i.pravatar.cc/150?u=2" className={styles.tinyAvatar} alt="user" />
              <img src="https://i.pravatar.cc/150?u=3" className={styles.tinyAvatar} alt="user" />
            </div>
