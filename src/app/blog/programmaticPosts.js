...
const COVER_POOL = [
  { src: '/templates/template-1.png', theme: 'resume' },
  { src: '/templates/template-2.png', theme: 'resume' },
  { src: '/templates/template-3.png', theme: 'ats' },
  { src: '/templates/template-4.png', theme: 'resume' },
  { src: '/templates/template-5.png', theme: 'ats' },
  { src: '/templates/template-6.png', theme: 'resume' },
  { src: '/templates/template-7.png', theme: 'resume' },
  { src: '/templates/template-8.png', theme: 'ats' },
  { src: '/templates/template-9.png', theme: 'resume' },
  { src: '/templates/template-10.png', theme: 'resume' },
  { src: '/templates/template-11.png', theme: 'resume' },
  { src: '/templates/template-12.png', theme: 'resume' },
  { src: '/templates/template-13.png', theme: 'resume' },
  { src: '/templates/template-14.png', theme: 'resume' },
  { src: '/templates/template-15.png', theme: 'resume' },
  { src: '/linkedin-save-pdf-guide.png', theme: 'linkedin' },
  { src: '/linkedin-makeover.png', theme: 'linkedin' },
  { src: '/hero-images/dbsuagbknhl0ry64xurq.webp', theme: 'resume' },
  { src: '/hero-images/nlut5socqakwn6twlcjx.webp', theme: 'resume' },
  { src: '/hero-images/nypg6oywh2aeh6rf2ukj.webp', theme: 'ats' },
  { src: '/hero-images/tqrzbjupdasigynxnsgz.webp', theme: 'resume' },
];
...
const BLOG_50_CONFIG = [
  // Resume score series
  { slug: 'resume-score-50-fix', title: 'Resume Score 50: What It Means + How to Improve', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Low resume score? Learn why and how to fix it fast.', coverEmoji: '📊', tags: 'ATS, Resume Score', type: 'score', score: 50, primaryTool: 'ats' },
  { slug: 'resume-score-60-improve', title: "Resume Score 60: Why You're Not Getting Calls", category: 'ATS Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Improve your resume score from average to interview-ready.', coverEmoji: '📊', tags: 'ATS, Resume Tips', type: 'score', score: 60, primaryTool: 'ats' },
  { slug: 'resume-score-70-guide', title: 'Resume Score 70: Is It Good Enough?', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Find out if your resume score is competitive.', coverEmoji: '📊', tags: 'ATS, Resume', type: 'score', score: 70, primaryTool: 'ats' },
  { slug: 'resume-score-80-tips', title: 'Resume Score 80: How to Reach 90+', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: "You're close to perfect, here’s how to get there.", coverEmoji: '📊', tags: 'ATS, Optimization', type: 'score', score: 80, primaryTool: 'ats' },
  { slug: 'resume-score-90-examples', title: 'Resume Score 90: What Top Resumes Do', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Learn from high-performing resumes.', coverEmoji: '📊', tags: 'Resume, ATS', type: 'score', score: 90, primaryTool: 'ats' },

  // Role guides
  { slug: 'software-engineer-resume', title: 'Software Engineer Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Build a resume that gets developer interviews.', coverEmoji: '💻', tags: 'Resume, Developer', type: 'job', role: 'Software Engineer', primaryTool: 'resume' },
  ...
  { slug: 'product-manager-resume', title: 'Product Manager Resume Guide', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Stand out as a product manager.', coverEmoji: '📦', tags: 'PM, Resume', type: 'job', role: 'Product Manager', primaryTool: 'resume' },
  { slug: 'marketing-manager-resume', title: 'Marketing Manager Resume Guide', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Improve your marketing resume.', coverEmoji: '📢', tags: 'Marketing, Resume', type: 'job', role: 'Marketing Manager', primaryTool: 'resume' },
  { slug: 'sales-resume-guide', title: 'Sales Executive Resume Guide', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Win more sales interviews.', coverEmoji: '💼', tags: 'Sales, Resume', type: 'job', role: 'Sales Executive', primaryTool: 'resume' },

  // Experience-level guides
  { slug: 'resume-0-years', title: 'Resume for Freshers (0 Years Experience)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Best resume format for freshers.', coverEmoji: '🎓', tags: 'Fresher, Resume', type: 'experience', yearsLabel: '0 years', primaryTool: 'resume' },
  { slug: 'resume-1-year', title: 'Resume for 1 Year Experience', category: 'Resume Guides', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Early career resume tips.', coverEmoji: '🎓', tags: 'Resume', type: 'experience', yearsLabel: '1 year', primaryTool: 'resume' },
  { slug: 'resume-3-years', title: 'Resume for 3 Years Experience', category: 'Resume Guides', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Optimize your mid-level resume.', coverEmoji: '💼', tags: 'Resume', type: 'experience', yearsLabel: '3 years', primaryTool: 'resume' },
  { slug: 'resume-5-years', title: 'Resume for 5 Years Experience', category: 'Resume Guides', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Level up your resume with sharper proof.', coverEmoji: '💼', tags: 'Resume', type: 'experience', yearsLabel: '5 years', primaryTool: 'resume' },
  { slug: 'resume-10-years', title: 'Resume for 10+ Years Experience', category: 'Resume Guides', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Executive resume strategy and leadership proof.', coverEmoji: '💼', tags: 'Resume', type: 'experience', yearsLabel: '10+ years', primaryTool: 'resume' },

  // Skills optimization
  { slug: 'python-skill-resume', title: 'How to Add Python in Resume', category: 'Skills Optimization', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Showcase Python effectively with proof and outcomes.', coverEmoji: '🐍', tags: 'Skills, Resume', type: 'skill', skill: 'Python', primaryTool: 'ats' },
  { slug: 'sql-skill-resume', title: 'How to Add SQL in Resume', category: 'Skills Optimization', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Highlight SQL skills properly for data-driven roles.', coverEmoji: '📊', tags: 'Skills, Resume', type: 'skill', skill: 'SQL', primaryTool: 'ats' },
  { slug: 'communication-skills-resume', title: 'How to Add Communication Skills', category: 'Skills Optimization', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Avoid generic soft skills and show real communication impact.', coverEmoji: '💬', tags: 'Skills', type: 'skill', skill: 'Communication', primaryTool: 'ats' },
  { slug: 'leadership-skills-resume', title: 'How to Add Leadership Skills', category: 'Skills Optimization', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Show leadership through outcomes, scope, and ownership.', coverEmoji: '👥', tags: 'Skills', type: 'skill', skill: 'Leadership', primaryTool: 'ats' },
  ...
  { slug: 'linkedin-headline-fresher', title: 'LinkedIn Headline Examples for Freshers', category: 'LinkedIn Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Improve your LinkedIn headline to show role fit instantly.', coverEmoji: '👤', tags: 'LinkedIn', type: 'linkedin', primaryTool: 'linkedin' },
  { slug: 'linkedin-headline-developer', title: 'LinkedIn Headlines for Developers', category: 'LinkedIn Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Stand out to recruiters with keyword-rich developer headlines.', coverEmoji: '👤', tags: 'LinkedIn', type: 'linkedin', primaryTool: 'linkedin' },
  { slug: 'linkedin-about-examples', title: 'LinkedIn About Section Examples', category: 'LinkedIn Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Write a powerful summary that gets profile views and replies.', coverEmoji: '👤', tags: 'LinkedIn', type: 'linkedin', primaryTool: 'linkedin' },
  { slug: 'linkedin-summary-students', title: 'LinkedIn Summary for Students', category: 'LinkedIn Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Best student summaries with clear positioning and proof.', coverEmoji: '👤', tags: 'LinkedIn', type: 'linkedin', primaryTool: 'linkedin' },
  { slug: 'linkedin-profile-optimize', title: 'LinkedIn Profile Optimization Guide', category: 'LinkedIn Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Boost recruiter visibility with a structured optimization plan.', coverEmoji: '👁️', tags: 'LinkedIn', type: 'linkedin', primaryTool: 'linkedin' },

  // ATS troubleshooting
  { slug: 'why-resume-fails-ats', title: 'Why Your Resume Fails ATS', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Common ATS rejection reasons and what to fix first.', coverEmoji: '⚠️', tags: 'ATS', type: 'ats', primaryTool: 'ats' },
  { slug: 'resume-not-shortlisted', title: 'Resume Not Getting Shortlisted?', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Fix the most common rejection issues fast.', coverEmoji: '⚠️', tags: 'Resume', type: 'ats', primaryTool: 'ats' },
  { slug: 'resume-formatting-ats', title: 'Fix Resume Formatting for ATS', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Improve formatting so ATS extraction stays clean.', coverEmoji: '📄', tags: 'ATS', type: 'ats', primaryTool: 'ats' },
  { slug: 'resume-keywords-missing', title: 'Missing Keywords in Resume?', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Add the correct keywords without sounding forced.', coverEmoji: '🔍', tags: 'ATS', type: 'ats', primaryTool: 'ats' },
  { slug: 'how-recruiters-read-resume', title: 'How Recruiters Scan Your Resume', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Understand recruiter behavior and optimize for the 6-second scan.', coverEmoji: '👁️', tags: 'Resume', type: 'ats', primaryTool: 'ats' },

  // Templates
  { slug: 'resume-templates-fresher', title: 'Best Resume Templates for Freshers', category: 'Templates', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Top fresher templates that stay clean and ATS-friendly.', coverEmoji: '📄', tags: 'Templates', type: 'templates', primaryTool: 'templates' },
  { slug: 'resume-templates-developers', title: 'Resume Templates for Developers', category: 'Templates', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Developer templates that emphasize projects and impact.', coverEmoji: '💻', tags: 'Templates', type: 'templates', primaryTool: 'templates' },
  { slug: 'resume-templates-managers', title: 'Resume Templates for Managers', category: 'Templates', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Professional templates designed for leadership roles.', coverEmoji: '💼', tags: 'Templates', type: 'templates', primaryTool: 'templates' },
  { slug: 'ats-friendly-templates', title: 'Best ATS-Friendly Resume Templates', category: 'Templates', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Templates that pass ATS and still look premium.', coverEmoji: '📄', tags: 'ATS, Templates', type: 'templates', primaryTool: 'templates' },
  { slug: 'one-page-resume-templates', title: 'Best One Page Resume Templates', category: 'Templates', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Compact formats that stay recruiter-friendly.', coverEmoji: '📄', tags: 'Templates', type: 'templates', primaryTool: 'templates' },
  { slug: 'two-page-resume-templates', title: 'Best Two Page Resume Templates', category: 'Templates', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Detailed formats for senior and specialist roles.', coverEmoji: '📄', tags: 'Templates', type: 'templates', primaryTool: 'templates' },

  // Additional posts to reach 50 (high-intent roles + score coverage)
  { slug: 'resume-score-40-meaning', title: 'Resume Score 40: Why You’re Being Filtered Out', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'A score of 40 usually indicates foundational issues. Fix them fast.', coverEmoji: '📉', tags: 'ATS, Resume Score', type: 'score', score: 40, primaryTool: 'ats' },
  { slug: 'resume-score-95-secrets', title: 'Resume Score 95: What Elite Candidates Do Differently', category: 'ATS Optimization', date: 'March 26, 2026', author: 'Priya Nair', authorRole: 'Head of Product', authorInitials: 'PN', authorColor: '#2563eb', excerpt: 'Learn the final refinements that push a strong resume into elite territory.', coverEmoji: '🏆', tags: 'ATS, Resume Score', type: 'score', score: 95, primaryTool: 'ats' },
  { slug: 'data-scientist-resume', title: 'Data Scientist Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Position ML projects and business impact for data science roles.', coverEmoji: '🧠', tags: 'Data Science, Resume', type: 'job', role: 'Data Scientist', primaryTool: 'resume' },
  { slug: 'devops-engineer-resume', title: 'DevOps Engineer Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Show reliability, scale, and automation outcomes for DevOps.', coverEmoji: '🛠️', tags: 'DevOps, Resume', type: 'job', role: 'DevOps Engineer', primaryTool: 'resume' },
  { slug: 'ui-ux-designer-resume', title: 'UI/UX Designer Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Present design process and measurable UX impact cleanly.', coverEmoji: '🎨', tags: 'Design, Resume', type: 'job', role: 'UI/UX Designer', primaryTool: 'resume' },
  { slug: 'business-analyst-resume', title: 'Business Analyst Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Highlight analysis, stakeholder alignment, and outcomes.', coverEmoji: '📈', tags: 'Business Analyst, Resume', type: 'job', role: 'Business Analyst', primaryTool: 'resume' },
  { slug: 'project-manager-resume', title: 'Project Manager Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Show delivery, risk management, and on-time outcomes.', coverEmoji: '🗓️', tags: 'Project Management, Resume', type: 'job', role: 'Project Manager', primaryTool: 'resume' },
  { slug: 'customer-success-manager-resume', title: 'Customer Success Manager Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Show retention, expansion, and customer outcomes with metrics.', coverEmoji: '🤝', tags: 'Customer Success, Resume', type: 'job', role: 'Customer Success Manager', primaryTool: 'resume' },
  { slug: 'finance-analyst-resume', title: 'Finance Analyst Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Highlight modeling, forecasting, and decision impact.', coverEmoji: '💹', tags: 'Finance, Resume', type: 'job', role: 'Finance Analyst', primaryTool: 'resume' },
  { slug: 'hr-manager-resume', title: 'HR Manager Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Show hiring outcomes, process improvements, and people impact.', coverEmoji: '🧩', tags: 'HR, Resume', type: 'job', role: 'HR Manager', primaryTool: 'resume' },
  { slug: 'operations-manager-resume', title: 'Operations Manager Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Show throughput, process design, and cost savings clearly.', coverEmoji: '⚙️', tags: 'Operations, Resume', type: 'job', role: 'Operations Manager', primaryTool: 'resume' },
  { slug: 'graphic-designer-resume', title: 'Graphic Designer Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Show portfolio context, tools, and measurable creative outcomes.', coverEmoji: '🖼️', tags: 'Design, Resume', type: 'job', role: 'Graphic Designer', primaryTool: 'resume' },
  { slug: 'data-engineer-resume', title: 'Data Engineer Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Highlight pipelines, reliability, and performance metrics.', coverEmoji: '🧱', tags: 'Data Engineering, Resume', type: 'job', role: 'Data Engineer', primaryTool: 'resume' },
  { slug: 'cybersecurity-analyst-resume', title: 'Cybersecurity Analyst Resume Guide (Examples + Keywords)', category: 'Resume Guides', date: 'March 26, 2026', author: 'Aditya Gupta', authorRole: 'Founder', authorInitials: 'AG', authorColor: '#16a34a', excerpt: 'Show risk reduction, monitoring, and incident response outcomes.', coverEmoji: '🛡️', tags: 'Cybersecurity, Resume', type: 'job', role: 'Cybersecurity Analyst', primaryTool: 'resume' },
];
